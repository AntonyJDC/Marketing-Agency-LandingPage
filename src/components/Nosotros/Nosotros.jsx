...
const Nosotros = () => {
    return (
        <section class="bg-white dark:bg-gray-900 pb-0" id='Nosotros'>
            ...
            <div class="gap-16 items-center justify-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400 px-8 py-8 text-center sm:text-center lg:text-start sm:p-8 lg:p-0">
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">¿Quiénes somos y qué hacemos?</h2>
