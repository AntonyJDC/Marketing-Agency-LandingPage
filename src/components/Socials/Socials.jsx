...
const Socials = () => {
    return (
        <div className="hidden lg:fixed lg:h-screen lg:flex lg:items-center lg:right-0 lg:p-4 lg:z-10">
            <ul className="flex py-0 lg:m-0 lg:flex lg:flex-col space-y-2 justify-center items-center">
                <li>
                    {/*INSTRAGRAM*/}
                    <button
                        type="button"
                ...
                <li>
                    ...
                    <button
                        ...
                        data-twe-ripple-init
                        data-twe-ripple-color="light"
                        class="mb-2 inline-block rounded-full bg-[#333] p-3 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
                        <span class="[&>svg]:h-4 [&>svg]:w-4">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="currentColor"
